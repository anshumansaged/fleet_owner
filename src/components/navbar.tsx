      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xl font-black bg-gradient-to-r from-slate-900 to-blue-900 bg-clip-text text-transparent">
                  Fleet Manager
                </div>
                <div className="text-xs text-slate-500 font-medium">Driver Management System</div>
              </div>
            </Link>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white/90 backdrop-blur-md rounded-xl mt-2 shadow-xl border border-white/20">
              {navigation.map((item) => {
                const isActive = pathname === item.href;
                return (
                  <Link
